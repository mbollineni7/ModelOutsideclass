...
///
/// Base Object Name:        SU_ASMT_PAST_LEGAL_STATUS
/// Base Object Type:        Table
///
///  Class Information:
/// 	Base ClassName:      AbstractDomainObject
/// 	ClassName:           SuAsmtPastLegalStatusBase
/// 	Name Space Name:     DSHS.CMBHS.Model
///
///  File Information:
/// 	Template File Name:  CMBHSTableDomain
/// 	Class File Name:         SuAsmtPastLegalStatusBase.cs
///
/// Primary Key Name	PrimaryKeyColumnName 
/// SU_ASMT_PAST_LEGAL_PK SU_ASMT_PAST_LEGAL_NBR
///   </summary>

	public class SuAsmtPastLegalStatusBase : AbstractDomainObject
	{
		...
		/// <summary>
		/// SuAsmtPastLegalNbr property accessor
		/// </summary>
		public virtual int SuAsmtPastLegalNbr{ get; set;}
		...
		/// <summary>
		/// PastLegalStatus property accessor
		/// </summary>
		[CustomAttribute.ReferencedClass("DSHS.CMBHS.Model.SuAsmtLegalStatusBase,DSHS.CMBHS.Model")]
		public virtual short PastLegalStatus{ get; set;}
