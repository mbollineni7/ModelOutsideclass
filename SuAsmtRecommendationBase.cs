...
///
/// Base Object Name:        SU_ASMT_RECOMMENDATION
/// Base Object Type:        Table
///
///  Class Information:
/// 	Base ClassName:      AbstractDomainObject
/// 	ClassName:           SuAsmtRecommendationBase
/// 	Name Space Name:     DSHS.CMBHS.Model
///
///  File Information:
/// 	Template File Name:  CMBHSTableDomain
/// 	Class File Name:         SuAsmtRecommendationBase.cs
///
/// Primary Key Name	PrimaryKeyColumnName 
/// SUASMTRECOMMENDATION_PK SU_ASMT_RECOMMENDATION_NBR
///   </summary>

	public class SuAsmtRecommendationBase : AbstractDomainObject
	{
		...
		/// <summary>
		/// SuAsmtRecommendationNbr property accessor
		/// </summary>
		[CustomAttribute.Comment("Primary Key - Unique row identifier.")]
		public virtual int SuAsmtRecommendationNbr{ get; set;}
		...
		/// <summary>
		/// PriorityPopulatationStatus property accessor
		/// </summary>
		[CustomAttribute.ReferencedClass("DSHS.CMBHS.Model.PriorityPopulationBase,DSHS.CMBHS.Model")]
		public virtual short PriorityPopulatationStatus{ get; set;}
		...
		// to not render as an XmlElement (otherwise value types like short would render an element's text as -32768).
		[System.Xml.Serialization.XmlIgnore]
		public virtual bool PriorityPopulatationStatusSpecified
		{
			get { return PriorityPopulatationStatus != short.MinValue; }
		}


		/// <summary>
		/// ModificationTreatment property accessor
		/// </summary>
		[CustomAttribute.Comment("Modification to Treatment Recommended.")]
		public virtual string ModificationTreatment{ get; set;}
		...
		// to not render as an XmlElement (otherwise value types like short would render an element's text as -32768).
		[System.Xml.Serialization.XmlIgnore]
		public virtual bool ModificationTreatmentSpecified
		{
			get { return ModificationTreatment != string.Empty; }
		}


		/// <summary>
		/// RecommendationComment property accessor
		/// </summary>
		[CustomAttribute.Comment("Recommendation comment")]
		public virtual string RecommendationComment{ get; set;}
		...
		// to not render as an XmlElement (otherwise value types like short would render an element's text as -32768).
		[System.Xml.Serialization.XmlIgnore]
		public virtual bool RecommendationCommentSpecified
		{
			get { return RecommendationComment != string.Empty; }
		}


		/// <summary>
		/// SupportNeedComment property accessor
		/// </summary>
		[CustomAttribute.Comment("Client selected support needs comment.")]
		public virtual string SupportNeedComment{ get; set;}
		...
		// to not render as an XmlElement (otherwise value types like short would render an element's text as -32768).
		[System.Xml.Serialization.XmlIgnore]
		public virtual bool SupportNeedCommentSpecified
		{
			get { return SupportNeedComment != string.Empty; }
		}
