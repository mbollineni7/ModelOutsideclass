...
//   <summary>
	...
	// Schema:         CMBHS_DEV3
	// Date Generated: Saturday, May 13, 2017
//   
...
///   </summary>
	...
	public class SuAssessmentLegalBase : AbstractDomainObject
	{
		...
		/// <summary>
		/// HistLegalStatus property accessor
		/// </summary>
		[CustomAttribute.Comment("Past legal status?")]
		public virtual short HistLegalStatus{ get; set;}
		...
		// to not render as an XmlElement (otherwise value types like short would render an element's text as -32768).
		[System.Xml.Serialization.XmlIgnore]
		public virtual bool HistLegalStatusSpecified
		{
			get { return HistLegalStatus != short.MinValue; }
		}
